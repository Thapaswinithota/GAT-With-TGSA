...
def arg_parse():
    ...
    parser.add_argument('--layer', type=int, default=3, help='number of GAT layer')
...
def main():
    ...
    if args.mode == "train":
        ...
        print('Train reslut: rmse:{} MAE:{} r2:{} r:{}'.format(train_rmse, train_MAE, train_r2, train_r))
        print('Val reslut: rmse:{} MAE:{} r2:{} r:{}'.format(val_rmse, val_MAE, val_r2, val_r))
